...
def main():
    ...
    NeuralNetwork_1.neurons[0].create_connection('-->', NeuralNetwork_1.neurons[1], "W04")

    NeuralNetwork_1.neurons[0].initialize_the_weights_of_the_neuron()

    for neurons in NeuralNetwork_1.neurons:
        neurons.print_neuron_info()
